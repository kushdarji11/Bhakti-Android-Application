...
public class List32 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list32);
        Integer[] imgs = {R.drawable.shanidevlist,R.drawable.shanidevlist,R.drawable.shanidevlist,R.drawable.shanidevlist};
        ...
        String[]  material = {"आरती","चालीसा","मंत्र","श्लोक"};
        ListView listView = (ListView)findViewById(R.id.listView);

        getSupportActionBar().setTitle("Shanidev");
        ...
        navigationView.setCheckedItem(R.id.shani);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (position==0){
                    ...
                    Intent intent = new Intent(getApplicationContext(),C6L1.class);
                    startActivity(intent);
                }
                if (position==1){
                    Log.e("CLICKED_1", "HERE");
                    Intent intent = new Intent(getApplicationContext(),C6L2.class);
                    startActivity(intent);
                }
                if (position==2){
                    Log.e("CLICKED_2", "HERE");
                    Intent intent = new Intent(getApplicationContext(),C6L3.class);
                    startActivity(intent);
                }
                if (position==3){
                    Log.e("CLICKED_3", "HERE");
                    Intent intent = new Intent(getApplicationContext(),C6L4.class);
                    startActivity(intent);
                }
            }
        });
